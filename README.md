...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rastervision-gdal-vsi-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14565&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rastervision-gdal-vsi-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rastervision-gdal-vsi` can be installed with:

```
conda install rastervision-gdal-vsi
```

It is possible to list all of the versions of `rastervision-gdal-vsi` available on your platform with:
